                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <div class="row">
                            <div class="col-md-9 col-sm-12">
                                ...
                                <p class="card-text description mb-auto text-muted">
                                    {{ $course->description }}
                                </p>
                                <p class="course-teacher text-start text-muted py-3">
                                    {{ 'Преподаватель: '.$course->teacher->user->surname.' '.$course->teacher->user->name .' '.$course->teacher->user->patronymic }}
                            ...
                            <div class="col-md-3 col-sm-0 d-none d-md-block">
                                @if($course->img)
                            ...
                            <div class="course-bottom d-flex justify-content-between align-items-center mt-4">
                                <p class="text-primary my-auto">
                                    {{ $course->training_period }}
                                </p>
                                @if(Auth::user()->user_type == 'Ученик' )
                                    @if(Auth::user()->pupil->hasCourse($course->id))
                                        <a class="register-status btn text-success">
                                    ...
                                    @else
                                        <form class="d-flex d-print-inline">
                                            ...
                                            <a class="register-status btn text-primary">
                                                Записаться
                                            </a>
                                        </form>
                                    @endif
