    ...
    public function create(Request $request){
        ...
        foreach (Teacher::whereIn('id', $request->teachers)->get() as $teacher){
            if ($teacher->schedule
                ...
                Session::flash('error', 'В указанное время преподаватель '.$teacher->surname.' '.$teacher->name.' '.$teacher->patronymic.' занят');
                return response()->json(array('message'=> 'В указанное время преподаватель '.$teacher->surname.' '.$teacher->name.' '.$teacher->patronymic.' занят'));
            }
        }
...
//        return $schedule->teacher->first();
    ...
    public function delete(Request $request){
        Schedule::find($request->schedule_id)->forceDelete();
